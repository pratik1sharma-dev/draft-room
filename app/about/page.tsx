    ...
    <main className="max-w-3xl mx-auto px-6 py-12">
      ...
      <div className="space-y-6 text-[var(--color-blueprint-text-secondary)] leading-relaxed">
        <p>
          ...
          and a set of drawings that need to be done by Friday. You call the usual draftsman — busy. You ask
        ...
        <p>
          ...
          still hiring draftsmen over WhatsApp.
        </p>
        <p>
          DraftRoom is the platform we wish existed — a dedicated space where architects and designers can
          find skilled draftsmen quickly, see their actual work, agree on scope and rate, and get drawings
        ...
        <p>
          ...
          Every draftsman who signs up early earns a <span className="text-amber-400">Founding Member</span> badge
